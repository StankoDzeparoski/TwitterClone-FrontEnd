...
export default function CreateCommentInline({
  postId,
  isLoggedIn,
  onCreated,
}: {
    ...
    <div className="rounded-2xl border border-border bg-card p-3 text-card-fg shadow-sm">
      ...
      <div className="mt-2 flex items-center justify-between">
        ...
        <button
          ...
          className="rounded-xl bg-fg px-4 py-2 text-sm font-medium text-bg shadow-sm hover:opacity-90 disabled:opacity-50"
        >
